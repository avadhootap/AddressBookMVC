...
namespace AddressBook.Helper
{
    public class PhoneHelper
    {
        ...
        public List<PhoneNo> GetAllPhoneNos(string id=null)
        {
            List<PhoneNo> list = new List<PhoneNo>();
            DataAccess dataAccess = new DataAccess();
            ...
            if (id != null)
            {
                query = "select * from phonenos where personId=@personId and isDelete=0";
        ...
        {
            DataAccess dataAccess=new DataAccess();
            string query = "Update phoneNos set phoneNoType=@phoneNoType,phoneNo=@phoneNo where phoneNoId=@phoneNoId";
