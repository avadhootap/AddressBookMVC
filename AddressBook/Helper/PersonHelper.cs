...
namespace AddressBook.Helper
{
    public class PersonHelper
    {
        ...
        {
            string query = "update person set title=@title,firstName=@firstName,lastName=@lastName,middleName=@middleName,age=@age,DOB=@DOB,gender=@gender,category=@category where personId=@personId";
            DataAccess data = new DataAccess();
            Dictionary<string, object> mydictionary = new Dictionary<string, object>
            {
